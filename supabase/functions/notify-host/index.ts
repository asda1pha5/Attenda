...
Deno.serve(async (request) => {
  ...
  try {
    ...
    const actionLink = hubUrl
      ? `<a href="${escapeAttribute(hubUrl)}" style="display:inline-block;padding:14px 20px;border-radius:8px;background:#64795f;color:#ffffff;font-family:Arial,sans-serif;font-size:15px;font-weight:700;text-decoration:none;">Open your event hub</a>`
      : '';
    const html = `<!doctype html><html><body style="margin:0;padding:0;background:#f4f5ef;color:#26332a;"><div style="display:none;max-height:0;overflow:hidden;opacity:0;">${actionTitle} for ${eventTitle}</div><table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f4f5ef;"><tr><td align="center" style="padding:36px 16px;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#fffdf9;border:1px solid #dde4d9;border-radius:18px;overflow:hidden;"><tr><td style="padding:30px 32px 20px;border-bottom:1px solid #edf0e9;"><div style="font-family:Georgia,'Times New Roman',serif;font-size:30px;font-weight:700;letter-spacing:-.03em;color:#26332a;">Attendaa</div><div style="margin-top:6px;font-family:Arial,sans-serif;font-size:11px;font-weight:700;letter-spacing:.12em;color:#72806c;">PLAN · INVITE · CELEBRATE</div></td></tr><tr><td style="padding:34px 32px 32px;"><p style="margin:0 0 10px;font-family:Arial,sans-serif;font-size:11px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:#72806c;">Guest activity</p><h1 style="margin:0 0 16px;font-family:Georgia,'Times New Roman',serif;font-size:31px;line-height:1.18;color:#26332a;">${actionTitle}</h1><p style="margin:0 0 26px;font-family:Arial,sans-serif;font-size:16px;line-height:1.65;color:#4c594d;">${bodyCopy}</p>${actionLink}<p style="margin:28px 0 0;font-family:Arial,sans-serif;font-size:12px;line-height:1.55;color:#778177;">You received this note because you host ${eventTitle} on Attendaa.</p></td></tr></table></td></tr></table></body></html>`;
